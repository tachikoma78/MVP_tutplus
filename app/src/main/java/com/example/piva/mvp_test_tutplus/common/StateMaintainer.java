package com.example.piva.mvp_test_tutplus.common;
...
public class StateMaintainer {
    ...
    public boolean firstTimeIn() {
        try {
            ...
            if (mStateMaintainerFrag == null) {
                Log.d(TAG, "Create new RetainedFragment " + mStateMaintenerTag);
                ...
                Log.d(TAG, "Returns existing retained fragment " + mStateMaintenerTag);
                mIsRecreating = true;
                return false;
            }
    ...
    /**
     * Fragment resposinble to preserve objects.
